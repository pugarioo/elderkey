...
const page = () => {
  const tiers = [
    { name: "Bronze", price: "0", color: "text-[#023047]", discountColor: "text-[#023047]" },
    { name: "Silver", price: "15", color: "text-[#FB8500]", discountColor: "text-[#FB8500]", isRecommended: true },
    { name: "Gold", price: "29", color: "text-[#8ECAE6]", discountColor: "text-[#8ECAE6]" },
  ];
    ...
    <div className="relative min-h-screen font-sans bg-[#F8F9FA] pb-20">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pt-20 flex flex-col items-center">
        ...
        <div className="text-center mb-16">
          <h1 className="font-serif text-[#023047] text-5xl font-black mb-4 tracking-tight">Select Membership Tier</h1>
          <p className="text-[#52796F] text-lg font-medium">Compare features and benefits across our concierge plans.</p>
        </div>
            ...
            <TableHeader>
              <TableRow className="hover:bg-transparent border-none">
                <TableHead className="w-1/4 p-10 pt-20 border-r border-gray-100">
                  <span className="text-[#023047]/60 font-bold uppercase tracking-widest text-[16px]">Plan Features</span>
                </TableHead>
                {tiers.map((tier) => (
                  <TableHead 
                    key={tier.name} 
                  ...
                  >
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <div className="text-[#023047] text-5xl font-bold flex items-baseline justify-center">
                        <span className="text-4xl">$</span>{tier.price}<span className="text-sm font-semibold text-gray-400 ml-1">/mo</span>
                      </div>
                      {tier.isRecommended && (
            ...
            <TableBody>
              ...
              <TableRow className="border-t border-gray-100 hover:bg-transparent">
                ...
                <TableCell className="p-10 text-center border-r border-gray-100">
                  <Button variant="outline" className="w-full rounded-xl py-6 border-gray-100 text-gray-400 font-bold hover:bg-gray-50 hover:shadow-md transition-all duration-300 cursor-pointer uppercase text-xs tracking-widest">
                    Select
                  </Button>
                </TableCell>
        ...
        <div className="mt-10 flex items-center gap-2 text-[#023047]/40 text-[10px] font-black tracking-[0.15em] uppercase">
          <FontIcon icon="fa-shield-halved" className="text-[#FFB703] text-sm" />
