          ...
          <div className="relative w-full max-w-lg h-fit max-h-screen overflow-y-auto no-scrollbar flex flex-col items-center justify-center zoom-in duration-300">
            ...
            <div className="flex bg-black/30 p-1 rounded-full border border-white/10 mb-8 flex-shrink-0">
              <button 
                ...
                className={`px-8 py-2 rounded-full text-[10px] cursor-pointer md:text-xs font-black tracking-widest uppercase transition-all ${
                  idCardView === 'front' ? 'bg-[#FFB703] text-[#023047] shadow-lg' : 'text-white/50 hover:bg-white/5'
                }`}
              >
                Front View
              </button>
              <button 
                ...
                className={`px-8 py-2 rounded-full text-[10px] cursor-pointer md:text-xs font-black tracking-widest uppercase transition-all ${
                  idCardView === 'back' ? 'bg-[#FFB703] text-[#023047] shadow-lg' : 'text-white/50 hover:bg-white/5'
                }`}
              >
                Back View
              </button>
