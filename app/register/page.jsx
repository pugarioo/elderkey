    ...
    <div className="relative min-h-screen bg-[#F8F9FA] flex flex-col items-center justify-center p-12 font-sans text-[#023047]">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          <p className="text-[#52796F] text-lg font-semibold opacity-75">Secure your digital membership in 3 simple steps.</p>
        </div>
        ...
        <div className="w-full max-w-[860px] bg-white rounded-[2.5rem] shadow-[0_15px_45px_-10px_rgba(2,48,71,0.08)] border border-[#001D3D]/5 p-20">
          ...
          <div className="flex justify-between items-center px-28 mb-16 relative">
            <div className="flex flex-col items-center z-10">
              ...
              <span className="text-[11px] font-bold font-sans text-[#FFB703] mt-4 tracking-[0.2em] uppercase">PROFILE</span>
            </div>
            ...
            <div className="flex flex-col items-center z-10 opacity-30">
              ...
              <span className="text-[11px] font-bold font-sans text-gray-400 mt-4 tracking-[0.2em] uppercase">VERIFY</span>
            </div>
            <div className="flex flex-col items-center z-10 opacity-30">
              ...
              <span className="text-[11px] font-bold font-sans text-gray-400 mt-4 tracking-[0.2em] uppercase">PLAN</span>
            </div>
          </div>
          ...
          <form className="space-y-10" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                <label className="text-[13px] font-bold font-sans text-[#023047] tracking-[0.15em] uppercase ml-1">FIRST NAME</label>
                <div className="relative flex items-center">
                  <span className="absolute left-6 z-20 pointer-events-none opacity-40">
                    <FontIcon icon="user" style="text-[#023047] text-base" />
                  </span>
                  <Input 
                    name="firstName"
              ...
              {/* Last Name */}
              <div className="space-y-4">
                <label className="text-[13px] font-bold font-sans text-[#023047] tracking-[0.15em] uppercase ml-1">LAST NAME</label>
                <div className="relative flex items-center">
                  <span className="absolute left-6 z-20 pointer-events-none opacity-40">
                    <FontIcon icon="user" style="text-[#023047] text-base" />
                  </span>
            ...
            {/* Email Address */}
            <div className="space-y-4">
              <label className="text-[13px] font-bold font-sans text-[#023047] tracking-[0.15em] uppercase ml-1">EMAIL ADDRESS</label>
              <div className="relative flex items-center">
                <span className="absolute left-6 z-20 pointer-events-none opacity-40">
                  <FontIcon icon="envelope" style="text-[#023047] text-base" />
                </span>
                <Input 
                  name="email"
                  type="email"
            ...
            <div className="grid grid-cols-2 gap-12">
              {/* Birth Date */}
              <div className="space-y-4">
                <label className="text-[13px] font-bold font-sans text-[#023047] tracking-[0.15em] uppercase ml-1">BIRTH DATE</label>
                <div className="relative flex items-center">
                  <Input 
                    name="birthDate"
                    type="date"
              ...
              {/* Mobile Number */}
              <div className="space-y-4">
                <label className="text-[13px] font-bold font-sans text-[#023047] tracking-[0.15em] uppercase ml-1">MOBILE NUMBER</label>
                <div className="relative flex items-center">
                  <span className="absolute left-6 z-20 pointer-events-none opacity-40">
                    <FontIcon icon="phone" style="text-[#023047] text-base" />
                  </span>
                  <Input 
                    name="mobileNumber"
            ...
            <div className="space-y-4 pt-2">
              <label className="text-[13px] font-bold font-sans text-[#023047] tracking-[0.15em] uppercase ml-1">SENIOR CITIZEN ID (OPTIONAL)</label>
              <div className="border-2 border-dashed border-[#FFB703]/30 bg-[#FFFBEB]/40 rounded-[2.5rem] py-16 flex flex-col items-center justify-center cursor-pointer hover:bg-[#FFFBEB] transition-all">
                ...
                <p className="text-[#52796F] text-sm mt-1 font-semibold opacity-50 uppercase tracking-[0.1em]">JPG or PNG. Max 5MB.</p>
              </div>
            </div>
